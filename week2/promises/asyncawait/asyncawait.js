...
var _this = this;
// b
var calculate = function (x, y, operation) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, operation(x, y)];
...
var resAdd = calculate(10, 5, add).then(function (res) { return console.log(res); });
console.log(resAdd);
